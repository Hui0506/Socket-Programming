...
int main()
{
	...
	//establish UDP socket in serverC
	...
	printf("%s\n", "The Server C is up and running using UDP on port <23205>");
	...
	while (1)
	{
		...
		printf("%s%s%s%lld\n", "The Server C has successfully finished the reduction ",fun,": ",Res);
		...
		printf("%s\n\n", "The Server C has successfully finished sending the reduction value to AWS");
	}
}
